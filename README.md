...
- Try-it Editor/previewer that can open/save and add an icon on filelist <img src"https://github.com/ldijkman/ESPxWebFlMgr/blob/master/examples/ESP8266basic/data/--try-it.png?raw=true">
